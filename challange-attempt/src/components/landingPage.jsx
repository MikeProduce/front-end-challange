...
//sm: 640,md:768,lg:1024;,xl:1280
    ...
    return (
        <section className='bg-Very-Light-Gray pb-10 md:py-20 md:px-14 lg:px-5 overflow-hidden md:overflow-visible'>
            <div className='lg:mx-20 md:flex md:flex-row-reverse md:py-32'>
            <div className='w-full h-full'>
            <img className='z-2 absolute -top-0 left-0 sm:-top-70  xxs:-top-20 xs:-top-30 smm:-top-30 md:hidden' src={MobilePhones} alt={MobilePhones}/>
